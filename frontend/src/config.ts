...
export const GOOGLE_REDIRECT_URI = process.env.EXPO_PUBLIC_GOOGLE_REDIRECT_URI || "YOUR_GOOGLE_REDIRECT_URI";
export const APPLE_REDIRECT_URI = process.env.EXPO_PUBLIC_APPLE_REDIRECT_URI || "YOUR_APPLE_REDIRECT_URI";
