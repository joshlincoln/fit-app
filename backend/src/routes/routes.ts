  ...
  CreateActivityRequest: {
    ...
    properties: {
      type: {
        dataType: 'union',
        subSchemas: [
          { dataType: 'enum', enums: ['Lift'] },
          { dataType: 'enum', enums: ['Cardio'] },
        ],
        required: true,
      },
      ...
      activities: {
        ...
        array: {
          ...
          nestedProperties: {
            ...
            exercise: { dataType: 'string', required: true },
          },
        },
        required: true,
      },
    ...
    function WorkoutTemplateController_createTemplate(request: any, response: any, next: any) {
      const args = {
        requestBody: {
          ...
          name: 'requestBody',
          required: true,
          ref: 'CreateWorkoutTemplateRequest',
        },
      };
