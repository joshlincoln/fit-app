...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/workouts',
            ...
            ...(fetchMiddlewares<RequestHandler>(WorkoutController.prototype.getWorkouts)),

            function WorkoutController_getWorkouts(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getWorkouts.apply(controller, validatedArgs as any);
        ...
        app.post('/workouts',
            ...
            const args = {
                    workout: {"in":"body","name":"workout","required":true,"ref":"Workout"},
            };
